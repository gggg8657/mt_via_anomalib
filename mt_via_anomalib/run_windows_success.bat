@echo off
chcp 65001 > nul
echo 🏆 성공하는 AI-VAD 모델 학습 (Post-processor 오류 해결)
echo ==========================================================
...
REM 학습 실행
echo.
echo 🎯 성공하는 AI-VAD 모델 학습을 시작합니다...
python train_aivad_success.py
...
echo.
echo 💡 성공하는 버전 특징:
echo - Post-processor 오류 완전 해결
echo - Tensor 크기 문제 해결
echo - AI-VAD 정확한 입력 형식 사용
echo - GPU 가속 지원 및 자동 진단
echo - 컴포넌트별 테스트 수행
echo - Post-processor 우회 기능
echo - 안정적인 모델 핵심 테스트
echo - 부분적 성공 시에도 체크포인트 생성
echo.
echo ⚠️  주의사항:
