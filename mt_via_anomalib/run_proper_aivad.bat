@echo off
echo ========================================
echo AI-VAD 올바른 학습 방법
echo (Density Estimation 기반 One-Class Learning)
echo ========================================
...
echo ✅ 학습 완료
echo 💾 생성된 파일: aivad_proper_learned.ckpt
