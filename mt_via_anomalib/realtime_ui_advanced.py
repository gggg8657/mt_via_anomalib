...
class AiVadInferencer:
    def __init__(self, device: str = "cuda") -> None:
        ...
        self.score_history = deque(maxlen=100)  # 최근 100개 점수
        self.threshold_alpha = 0.1  # 적응 임계치 학습률
        ...
        if regions is not None and len(regions) > 0:
            ...
            if self.show_boxes and 'boxes' in region:
                ...
                for i, (box, score) in enumerate(zip(boxes, scores)):
                    ...
                    color = (0, 0, 255) if score > 0.5 else (0, 255, 0)  # 빨간색: 이상, 녹색: 정상
    ...
    def update_adaptive_threshold(self, score: float) -> None:
        ...
        if len(self.score_history) >= 10:  # 충분한 데이터가 있을 때
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("AI-VAD Advanced Realtime Anomaly Detection")
    ...
    def _setup_ui(self) -> None:
        ...
        self.fps_timer.start(1000)  # 1초마다 업데이트
