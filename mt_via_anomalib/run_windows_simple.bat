@echo off
chcp 65001 > nul
echo 🏆 간단한 AI-VAD 모델 학습 (Avenue 데이터셋 우회)
echo ==========================================================
...
echo.
echo 📁 생성된 파일:
echo - aivad_simple_checkpoint.ckpt (학습된 모델)
echo.
echo 🚀 다음 단계:
...
echo.
echo 💡 간단한 버전 특징:
echo - Avenue 데이터셋 완전 우회
echo - IndexError 완전 해결
echo - GPU 가속 지원 및 자동 진단
echo - 간단하고 안정적인 모델 테스트
